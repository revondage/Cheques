...
class PDF_AutoPrint extends PDF_JavaScript{
  ...
  function ChapterTitle($num, $label){
    // $pdf->AddFont('GloucesterMT-ExtraCondensed','','fpdf/font/glebc.php');
    // $this->SetFont('GloucesterMT-ExtraCondensed','',12);
  ...
  function ChapterBody(){
    ...
    //Leyenda del Chqeque en Negritas
    // $this->SetFont('','B');
    $this->SetXY($lx,$ly);// $this->SetXY(148,88);
...
$pdf->SetFont('GloucesterMT-ExtraCondensed','',12);
