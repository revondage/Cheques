...
<wsdl:message name="no_surtidoResponse">
  <wsdl:part name="return" type="xsd:string" /></wsdl:message>
<wsdl:message name="finalizar_surtidoRequest">
  <wsdl:part name="key" type="xsd:string" />
  <wsdl:part name="sv600_id" type="xsd:int" />
  <wsdl:part name="numero_control" type="xsd:int" />
...
<wsdl:message name="finalizar_surtidoResponse">
  <wsdl:part name="return" type="xsd:string" /></wsdl:message>
...
<wsdl:message name="solicitar_permisoResponse">
  <wsdl:part name="return" type="xsd:string" /></wsdl:message>
<wsdl:message name="volver_actividadRequest">
  <wsdl:part name="key" type="xsd:string" />
  <wsdl:part name="sv600_id" type="xsd:int" /></wsdl:message>
<wsdl:message name="volver_actividadResponse">
  <wsdl:part name="return" type="xsd:string" /></wsdl:message>
...
<wsdl:portType name="APPServiciosPortType">
  ...
  <wsdl:operation name="finalizar_surtido">
    <wsdl:input message="tns:finalizar_surtidoRequest"/>
    <wsdl:output message="tns:finalizar_surtidoResponse"/>
  </wsdl:operation>
  ...
  <wsdl:operation name="solicitar_permiso">
   ...
   <wsdl:operation name="volver_actividad">
    <wsdl:input message="tns:volver_actividadRequest"/>
    <wsdl:output message="tns:volver_actividadResponse"/>
  </wsdl:operation>
...
<wsdl:binding name="APPServiciosBinding" type="tns:APPServiciosPortType">
  ...
  <wsdl:operation name="finalizar_surtido">
    <soap:operation soapAction="app:servicios#finalizar_surtido_fn" style="rpc"/>
    <wsdl:input><soap:body use="encoded" namespace="app:finalizar_surtido_fn" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/></wsdl:input>
    <wsdl:output><soap:body use="encoded" namespace="app:finalizar_surtido_fn" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/></wsdl:output>
  </wsdl:operation>
  <wsdl:operation name="arribo_domicilio">
  ...
  <wsdl:operation name="volver_actividad">
    <soap:operation soapAction="app:servicios#volver_actividad_fn" style="rpc"/>
    <wsdl:input><soap:body use="encoded" namespace="app:volver_actividad_fn" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/></wsdl:input>
    <wsdl:output><soap:body use="encoded" namespace="app:volver_actividad_fn" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/></wsdl:output>
  </wsdl:operation>
  <wsdl:operation name="alarmas">
...
<wsdl:service name="APPServicios">
  <wsdl:port name="APPServiciosPort" binding="tns:APPServiciosBinding">
     <soap:address location="http://10.1.1.18/web/htdocs/solemti/APPGasera/service"/>
  </wsdl:port>
</wsdl:service>
</wsdl:definitions>