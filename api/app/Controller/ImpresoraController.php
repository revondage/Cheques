...
class ImpresoraController extends AppController {
  ...
  //   $s_cheque = $_REQUEST['cheque'];
  //   $s_impresora = $_REQUEST['impresora'];
  //   // $s_sql = "SELECT * FROM usuario WHERE usuario = '".$s_validarusuario."'";
  //   // $s_sql = "SELECT * FROM configuracion WHERE impresora.nombre = '".$s_impresora."'";
  ...
  //       if($this->data == "") {
  //         $this->data = '{
  //           "banco"       :   "'.$res['configuracion']['banco'].'",
  //           "cheque"       :   "'.$res['configuracion']['cheque'].'",
  //           "impresora"       :   "'.$res['impresora']['nombre'].'",
  //         }';
  //       } else {
  //         $this->data .= ',{
  //           "banco"       :   "'.$res['configuracion']['banco'].'",
